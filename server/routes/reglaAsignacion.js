...
app.get('/reglaAsignacion', function(req, res) {
...
app.post('/reglaAsignacion', function(req, res) {
    let body = req.body;
...
app.put('/reglaAsignacion/:id', function(req, res) {
...
app.delete('/reglaAsignacion/:id', function(req, res) {
    let id = req.params.id;
